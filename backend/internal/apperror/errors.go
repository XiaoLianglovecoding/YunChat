...
var catalog = map[Code]Definition{
	...
	CodeUsernameTooShort: {400, "username must contain 3-50 characters"}, CodePasswordTooShort: {400, "password must contain at least 6 characters"}, CodeUsernameTaken: {409, "username already exists"}, CodeUserNotFound: {404, "user not found"}, CodeWrongPassword: {401, "wrong username or password"}, CodeInvalidToken: {401, "invalid or expired token"},
