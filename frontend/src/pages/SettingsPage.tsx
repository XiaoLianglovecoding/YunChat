  ...
  return (
    <>
      ...
      <section className="module-main settings-main">
        ...
        {section === "privacy" && <SettingsSection description="了解当前账户的安全与隐私策略。" title="隐私与安全"><div className="settings-callout"><ShieldCheck size={20} /><div><strong>改密会话保护已开启</strong><p>修改密码会撤销全部刷新会话，并要求使用新密码重新登录。</p></div></div></SettingsSection>}
        {section === "about" && <SettingsSection description="关于当前 MyIM Web 客户端。" title="关于"><div className="about-mark"><span><Info size={24} /></span><h3>MyIM</h3><p>Version 0.1.0 · Phase 02</p></div></SettingsSection>}
      </section>
    </>
  );
}
